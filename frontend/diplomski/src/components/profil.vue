...
<img src={{image}} width="50" height="50" alt="Image not found">
<br>
Email:{{email}}
<br>
Phone:{{phone}}
...
export default{
    ...
    if(this.type=="student"){
      UserService.getStudentById(localStorage.getItem('userId')).then(
        ...
        this.userService.getTeacherById(localStorage.getItem('userId')).then(
          (response)=>{
            let user=response.data;
            ...
            LessonService.getNextFiveLessons(user.id).subscribe((response)=>{
